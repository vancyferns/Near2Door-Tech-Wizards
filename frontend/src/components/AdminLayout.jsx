  ...
  <div className="flex">
    <nav className="w-1/4 bg-gray-200 p-4 min-h-screen">
      ...
      <ul className="space-y-2">
        <li>
          <button
            onClick={() => onNavigate({ name: "admin-dashboard" })}
        ...
        <li>
          <button
            onClick={() => onNavigate({ name: "admin-shops" })}
            className="w-full text-left p-2 rounded hover:bg-gray-300"
          >
            Manage Shops
          </button>
        ...
        <li>
          <button
            onClick={() => onNavigate({ name: "admin-orders" })}
            className="w-full text-left p-2 rounded hover:bg-gray-300"
          >
            View All Orders
          </button>
        ...
        <li>
          <button
            onClick={() => onNavigate({ name: "admin-agents" })}
            className="w-full text-left p-2 rounded hover:bg-gray-300"
          >
            View Agents
          </button>
        ...
        <li>
          <button
            onClick={() => onNavigate({ name: "admin-finances" })}
            className="w-full text-left p-2 rounded hover:bg-gray-300"
          >
            Finances
          </button>
