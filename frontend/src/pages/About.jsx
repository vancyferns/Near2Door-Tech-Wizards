    ...
    <div className="bg-slate-900 text-white min-h-screen py-16 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-slate-800 text-gray-100 p-8 md:p-12 rounded-3xl shadow-2xl mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-lime-400 mb-6">
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Card 1: Hyperlocal */}
            <div className="bg-slate-700 text-gray-200 p-8 rounded-3xl shadow-xl transition-transform duration-300 hover:scale-105">
              <div className="flex items-center justify-center text-lime-400 mb-6">
